...
- [Docker pilot, migration, Google re-auth](docs/runbooks/docker-pilot.md) — `IMAGE=ghcr.io/europeanresolve/er-calendar-bridge:0.1.0`, `secrets/operator/*`, `docker compose up -d`
