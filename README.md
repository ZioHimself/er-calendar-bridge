...
- [Docker pilot, migration, Google re-auth](docs/runbooks/docker-pilot.md) — `IMAGE=ghcr.io/europeanresolve/er-calendar-bridge:0.1.3`, `secrets/serhiy/*`, `docker compose up -d`
