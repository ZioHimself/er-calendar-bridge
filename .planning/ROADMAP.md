...
- [x] 05-02-PLAN.md — Multi-stage Dockerfile and .dockerignore (SYNC-17, TEST-05)
- [x] 05-03-PLAN.md — compose.yaml, .env.example, secrets onboarding (SYNC-17, OPS-01, SEC-04)
